...
| kimi-k2.5 | **0.611** | Moderate world model | 0.668 | 0.560 | 41/246 | 74.1% | 2.46 | 62.9% | 0.588 | 53.0% |
| llama-3.1-8b | **0.521** | Weak world model | 0.462 | 0.588 | 45/233 | 17.2% | 0.80 | 88.5% | 0.409 | 34.0% |
| mistral-small-24b | **0.506** | Weak world model | 0.443 | 0.578 | 31/236 | 43.1% | 1.66 | 81.5% | 0.623 | 58.7% |
| qwen3-next-80b-instruct | **0.526** | Weak world model | 0.430 | 0.644 | 32/237 | 39.7% | 1.87 | 90.3% | 0.502 | 42.7% |
...
- **kimi-k2.5**: agreement = 62.9%, SHD = 21.5 ± 4.4
- **llama-3.1-8b**: agreement = 88.5%, SHD = 6.7 ± 2.6
- **mistral-small-24b**: agreement = 81.5%, SHD = 10.8 ± 3.1
- **qwen3-next-80b-instruct**: agreement = 90.3%, SHD = 5.6 ± 2.8
...
### llama-3.1-8b: Weak world model (WMI = 0.521)
...
### mistral-small-24b: Weak world model (WMI = 0.506)

The model has a partial world model with moderate coverage but significant gaps. Some causal pathways are represented but the model cannot reliably generalise across novel variable combinations.

### qwen3-next-80b-instruct: Weak world model (WMI = 0.526)
